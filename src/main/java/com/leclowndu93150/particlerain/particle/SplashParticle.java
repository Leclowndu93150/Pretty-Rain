...
import com.leclowndu93150.particlerain.particle.model.ParticleModel;
import com.leclowndu93150.particlerain.particle.model.SplashBottomModel;
import com.leclowndu93150.particlerain.particle.model.SplashModel;
import com.leclowndu93150.particlerain.particle.model.SplashRimModel;
...
public class SplashParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        if (age <= this.wave1End) {
            ...
            WAVE_MODEL.renderToBuffer(matrixStack, vertexConsumer, light, minU, maxU, minV, maxV, r, g, b, ClientStuff.config.splashes.alpha);
