...
public class RippleParticle extends WeatherParticle {
    ...
    private RippleParticle(ClientLevel level, double x, double y, double z) {
        super(level, x, y, z);
        this.setSprite(Minecraft.getInstance().particleEngine.textureAtlas.getSprite(ResourceLocation.fromNamespaceAndPath(ParticleRainClient.MODID, "ripple0")));
        this.quadSize = 0.25F;
        this.alpha = 0.1F;
    ...
    public void tick() {
        ...
        this.setSprite(Minecraft.getInstance().particleEngine.textureAtlas.getSprite(ResourceLocation.fromNamespaceAndPath(ParticleRainClient.MODID, "ripple" + (this.age - 1))));
    }
